...
#
# 2024/12/28 ImageMaskDatasetGenerator.py
...
if __name__ == "__main__":
  try:
    output_dir = "./EndoScene-master/"
    if os.path.exists(output_dir):
      shutil.rmtree(output_dir)
    os.makedirs(output_dir)

    train_images_dir = "./EndoScene/TrainDataset/images/"
    train_masks_dir  = "./EndoScene/TrainDataset/masks/"
    # Enabled our offline augmentation.
    augmentation= True
